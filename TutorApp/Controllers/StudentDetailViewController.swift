...
class StudentDetailViewController: UIViewController {
  ...
  private func setTextForEmptyTableView() {
    ...
    addDescImageAttachment.image = UIImage(named: "Launchscreen")
    ...
    noDataLabel.centerYAnchor.constraint(equalTo: assignmentsTableView.centerYAnchor, constant: -assignmentsLabel.bounds.size.height).isActive = true
